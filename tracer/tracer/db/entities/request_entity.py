from sqlalchemy import Column, Integer, String, BigInteger, DateTime, Date, Time
...
class RequestEntity(Base):
    ...
    readable_date = Column(Date, nullable=False)
    readable_time = Column(Time, nullable=False)
